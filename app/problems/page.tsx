...
const problems = [
  ['Yellow cactus', 'Check watering, root health, light, and recent changes before assuming a nutrient problem.'],
  ['Brown or scorched patches', 'Look at light exposure, sudden sun changes, temperature, and whether tissue is dry or soft.'],
  ['Soft or mushy tissue', 'Act quickly: inspect the roots and stem for excess moisture and signs of rot.'],
  ['Wrinkled cactus', 'Wrinkling can indicate water stress, but season, temperature, roots, and species all matter.'],
  ['Not flowering', 'Check maturity, light, seasonal conditions, dormancy, and whether the plant has enough growth energy.'],
  ['Not growing', 'Review light, temperature, season, roots, pot size, and the plant’s normal growth rate.'],
  ['Pests', 'Inspect new growth, joints, spines, and hidden areas regularly so infestations are caught early.'],
  ['Stretching or leaning', 'Insufficient light is a common cause of elongated growth, but evaluate the whole growing setup.'],
]
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <section className="py-14">
        <div className="mb-8"><p className="text-xs font-bold uppercase tracking-[0.2em] text-cactus-600">Start with the symptom</p><h2 className="mt-2 font-serif text-3xl font-bold text-cactus-800">What is your cactus telling you?</h2></div>
        <div className="grid gap-5 sm:grid-cols-2">
          {problems.map(([title, description]) => (
            <article key={title} className="rounded-2xl border border-sand-200 bg-white p-6 shadow-sm">
              ...
              <Link href="/#latest" className="mt-5 inline-block text-sm font-bold text-cactus-700 hover:text-cactus-600">Browse related guides →</Link>
            </article>
          ))}
        </div>
      </section>
